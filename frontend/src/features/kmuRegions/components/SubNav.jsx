...
const tabs = [
  { label: "Overview", to: "/kmu-regions" },
  ...resourceTypes.map((r) => ({ label: r.label, to: `/kmu-regions/${r.slug}` })),
];

export default function KmuRegionsSubNav() {
  return (
    <nav
      aria-label="KMU Regions sections"
